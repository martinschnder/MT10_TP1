...
\begin{document}
    ...
    Chaque sommet correspond à un élément du groupe et on associe à chaque générateur un couleur d'arc. Si $g$ et $h$ deux éléments sont reliés par un arc $s$, alors $h = g*s$.
